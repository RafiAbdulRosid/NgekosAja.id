...
<header>
  <div class="navbar-custom">
    ...
    <img src="/NgekosAja.id/assets/uploads/logo.png" alt="logo" style="max-height: 48px">
</a>
      ...
      <?php if (!empty($_SESSION['user_id'])): ?>
          ...
          <a href="/NgekosAja.id/logout.php" class="btn-outline-custom">Logout</a>

      <?php else: ?>
          <a href="/NgekosAja.id/login.php" class="btn-outline-custom">Login</a>
          <a href="/NgekosAja.id/register.php" class="btn-white-custom">Daftar</a>
